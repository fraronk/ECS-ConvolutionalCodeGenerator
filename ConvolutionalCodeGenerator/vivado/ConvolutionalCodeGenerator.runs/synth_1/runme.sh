...
HD_PWD='C:/Repositories/ECS-ConvolutionalCodeGenerator/ConvolutionalCodeGenerator/vivado/ConvolutionalCodeGenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CCG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CCG.tcl
