...
HD_PWD='C:/Repositories/ECS-ConvolutionalCodeGenerator/ConvolutionalCodeGenerator/vivado/ConvolutionalCodeGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CCG.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CCG.tcl -notrace
